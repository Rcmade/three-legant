...
interface ToolbarButtonImageProps {
  editor: Editor;
}

export const ToolbarButtonImage = ({ editor }: ToolbarButtonImageProps) => {
...
export default memo(ToolbarButtonImage, (prevProps, nextProps) => {
